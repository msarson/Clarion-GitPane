...
public class NavigatePrevWindow : AbstractMenuCommand
{
	public override void Run()
	{
		if (WorkbenchSingleton.Workbench.ActiveWorkbenchWindow != null || WorkbenchSingleton.Workbench.PadContentCollection.FindAll(PadsNavigationDialog.VisiblePad).Count > 0)
		{
			...
			if (WorkbenchSingleton.Workbench.ActiveWorkbenchWindow != null)
			{
				...
				selectedViewIndex = (num + WorkbenchSingleton.Workbench.ViewContentCollection.Count - 1) % WorkbenchSingleton.Workbench.ViewContentCollection.Count;
			}
