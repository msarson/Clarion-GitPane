...
public class ClaMemberResolveResult : MemberResolveResult
{
	public ClaMemberResolveResult(IClass callingClass, IMember callingMember, IMember resolvedMember)
		: base(callingClass, callingMember, resolvedMember)
	{
	}
