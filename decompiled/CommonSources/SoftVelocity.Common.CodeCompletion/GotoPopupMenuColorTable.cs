...
internal class GotoPopupMenuColorTable : ProfessionalColorTable
{
	...
	internal static void InitTanLunaColors(ref Dictionary<KnownColors, Color> rgbTable)
	{
		...
		rgbTable[KnownColors.ImageMarginGradientBegin] = SystemColors.ButtonFace;
		rgbTable[KnownColors.ImageMarginGradientMiddle] = SystemColors.ButtonFace;
		rgbTable[KnownColors.ImageMarginGradientEnd] = SystemColors.ButtonFace;
